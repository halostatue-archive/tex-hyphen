...
# this file and hack it to suit your needs. There is nothing for end users
# here -- just specify the style parameter in call to new TeX::Hyphen.
#
...
# * process_hyphenation
#
# Check the 'tex/hyphen/czech.rb' source to see the exact form of the values
# inserted into these has structures.
#
# Each style module should also define DEFAULT_STYLE_MIN_LEFT and
# DEFAULT_STYLE_MIN_RIGHT global variables, if they have different values
# than the default 2. The values should match the paratemers used to
# generate the patterns. Since various pattern files could be generated with
# different values set, this is just a default that can be changed with
# parameters to the TeX::Hyphen constructor.
#
# Note: the encoding for this is ISO-8859-1 or ISO-8859-15.
module TeX::Hyphen::Czech
  BACKV  = {
    'c' => 'è', 'd' => 'ï', 'e' => 'ì', 'l' => 'µ', 'n' => 'ò', 'r' => 'ø',
    's' => '¹', 't' => '»', 'z' => '¾', 'C' => 'È', 'D' => 'Ï', 'E' => 'Ì',
    'L' => '¥', 'N' => 'Ò', 'R' => 'Ø', 'S' => '©', 'T' => '«', 'Z' => '®'
  }
  BACKAP = {
    'a' => 'á', 'e' => 'é', 'i' => 'í', 'l' => 'å', 'o' => 'ó', 'u' => 'ú',
    'y' => 'ı', 'A' => 'Á', 'E' => 'É', 'I' => 'Í', 'L' => 'Å', 'O' => 'Ó',
    'U' => 'Ú', 'Y' => 'İ'
  }
  ...
  # parse these lines, and fill values in @both_hyphen, @begin_hyphen,
  # @end_hyphen and @hyphen, members of the class. The function should
  # return false if end of the pattern section (macro) was reached, 1 if the
  ...
  # This method gets the lines of the \hyphenation content. It should parse
  # these lines and fill values into exception which is passed as second
  # parameter upon call. The function should return 0 if end of the
  # exception section (macro) was reached, 1 if the parsing should continue.
